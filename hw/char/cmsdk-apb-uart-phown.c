/*
 * ARM CMSDK APB UART emulation - picowallet 2024 edition (slight modification of the original driver)
 * The original implementation is available in hw/char/cmsdk-apb-uart.c.
 *
...
static bool uart_baudrate_ok(CMSDKAPBUARTPHOWN *s)
{
...
static void uart_update_parameters(CMSDKAPBUARTPHOWN *s)
{
...
static void cmsdk_apb_uart_update(CMSDKAPBUARTPHOWN *s)
{
...
{
    CMSDKAPBUARTPHOWN *s = CMSDK_APB_UART_PHOWN(opaque);
...
static void uart_cancel_transmit(CMSDKAPBUARTPHOWN *s)
{
    if (s->watch_tag) {
...
{
    CMSDKAPBUARTPHOWN *s = CMSDK_APB_UART_PHOWN(dev);
...
static void cmsdk_apb_uart_init(Object *obj)
{
    ...
    CMSDKAPBUARTPHOWN *s = CMSDK_APB_UART_PHOWN(obj);
...
static const VMStateDescription cmsdk_apb_uart_vmstate = {
    ...
    .fields = (const VMStateField[]) {
        VMSTATE_UINT32(state, CMSDKAPBUARTPHOWN),
        VMSTATE_UINT32(ctrl, CMSDKAPBUARTPHOWN),
        VMSTATE_UINT32(intstatus, CMSDKAPBUARTPHOWN),
        VMSTATE_UINT32(bauddiv, CMSDKAPBUARTPHOWN),
        VMSTATE_UINT8(txbuf, CMSDKAPBUARTPHOWN),
        VMSTATE_UINT8(rxbuf, CMSDKAPBUARTPHOWN),
        VMSTATE_END_OF_LIST()
    }
};

static Property cmsdk_apb_uart_properties[] = {
    DEFINE_PROP_CHR("chardev", CMSDKAPBUARTPHOWN, chr),
    DEFINE_PROP_UINT32("pclk-frq", CMSDKAPBUARTPHOWN, pclk_frq, 0),
...
static const TypeInfo cmsdk_apb_uart_info = {
    .name = TYPE_CMSDK_APB_UART_PHOWN,
    .parent = TYPE_SYS_BUS_DEVICE,
    .instance_size = sizeof(CMSDKAPBUARTPHOWN),
